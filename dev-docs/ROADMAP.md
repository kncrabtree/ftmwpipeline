...
2. **Fork once Stage 6 stabilizes — report generation favored over the
   ...
   - **Reports from the `.ftmw` record** (core; the favored next step, planned in
     ...
     into the user-facing pull calibration surface. The σ_f budget is diagnosed
