...
| [`planning/stage5-tau-calibration.md`](planning/stage5-tau-calibration.md) | Planning — replace upfront apodization with a data-driven τ calibration via sliding-active-window STFT, with LSQ-fit-and-histogram as the cross-validation control. Bidirectional τ penalty + rescue re-seeding. Phased workflow: synthetic prototype → 2638 application → comparison study → production wiring. Supersedes the §Dataset-wide-tau and §Broken-initial-fit sections of `stage5-cross-fixture-validation.md` |
