...
reproducibility artifacts for the noise-estimation research (see the noise/SNR-scaling
...
| 1019 | 3 µs | 1590380 | 5 | 4.35 | yes (some peak frequencies) | [1019/README.md](1019/README.md) |
| 1512 | 2 µs | 17860 | 1 | 3.35 | yes (vinyl cyanide; [catalog](vinyl-cyanide-reference/README.md)) | [1512/README.md](1512/README.md) |
| 1231 | 3 µs | 74740 | 1 | 4.35 | no | [1231/README.md](1231/README.md) |
| 655 | 2 µs | 2133080 | 6 | 3.35 | yes (vinyl cyanide, high SNR) | [655/README.md](655/README.md) |
| 360 | — | 775860 | 3 | 4.35 | no (MTBE sample) | [360/README.md](360/README.md) |
| 363 | — | 525660 | 2 | 4.35 | no (MTBE sample) | [363/README.md](363/README.md) |
...
The **1512** fixture anchors research reproduction, regression, and
documentation, pairing a checked-in `examples/blackchirp_data/` experiment with a
small tracked oracle and the regeneration recipe above:

- **1512** — a vinyl-cyanide line-catalog ground truth
  ([`vinyl-cyanide-reference/`](vinyl-cyanide-reference/)); the high-SNR
...
the tracked oracle is the durable label. Large fitted `.ftmw` artifacts are
regenerated on demand from the recipe above, never committed.
