...
PROPAGATION_FIELDS: list[tuple[str, Callable[..., None], Any, str, str]] = [
    ...
    (
        ...
        _t("conservative", "min_separation_factor"),
        1.7,
    ...
    (
        ...
        _t("conservative", "min_pair_separation_factor"),
        0.77,
    ...
    (
        ...
        _t("conservative", "min_pair_separation_resolution_factor"),
        1.3,
    ...
    (
        ...
        _t("conservative", "weak_window_snr_threshold"),
        33.0,
    ...
    (
        "seeder.seeder_rchi2",
        _t("seeder", "seeder_rchi2"),
        2.5,
        "seeder_rchi2_threshold",
        "conservative",
    ),
    (
        "seeder.seeder_straddle_factor",
        _t("seeder", "seeder_straddle_factor"),
        0.65,
    ...
    (
        ...
        _t("penalties", "phase_penalty_lambda"),
        999.0,
    ...
    (
        ...
        _t("penalties", "phase_penalty_cutoff_fwhm"),
        3.5,
    ...
    (
        ...
        _t("penalties", "amp_penalty_lambda"),
        25.0,
        "amp_penalty_lambda",
        "conservative",
    ),
    ...
    (
        ...
        _t("rescue", "cleanup_significance"),
        0.0123,
        "rescue_significance",
        "rescue",
    ),
    ...
    (
        ...
        _t("rescue", "merge_separation_factor"),
        1.25,
    ...
    (
        ...
        _t("rescue", "structural_merge_factor"),
        0.13,
    ...
    (
        ...
        _t("rescue", "overfit_amp_ratio_band"),
        1.9,
    ...
    (
        ...
        _t("rescue", "overfit_amp_ratio_threshold"),
        7.5,
