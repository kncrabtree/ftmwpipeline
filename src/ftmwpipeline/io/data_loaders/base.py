...
class BaseLoader(ABC):
    ...
    def validate_parameters(self, **kwargs) -> Dict[str, Any]:
        ...
        **kwargs
        ...
        if not result['valid']:
            raise LoaderError(f"Parameter validation failed: {'; '.join(result['errors'])}")
        
        return result
    
    def _create_source_metadata(self, source_path: Union[str, Path], **kwargs) -> Dict[str, Any]:
        """
        ...
        **kwargs
        ...
        if source_path.exists():
            ...
            metadata['source_modified'] = datetime.fromtimestamp(stat.st_mtime).isoformat()
