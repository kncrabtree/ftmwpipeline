...
class PipelineStageTracker:
    ...
    STAGE_DEPENDENCIES = {
        ...
        # lattice on the raw FID. Requires Stage 0 (the raw FID) and the
        # persisted Stage 1 active-region bounds, which the impl hard-requires.
        # Independent of the tau calibrations; persists only eps and does not
        # feed downstream stages (a reports feature consumes it).
        "timebase_calibration": ["stage0_fid_data", "stage1_complex_ft"],
